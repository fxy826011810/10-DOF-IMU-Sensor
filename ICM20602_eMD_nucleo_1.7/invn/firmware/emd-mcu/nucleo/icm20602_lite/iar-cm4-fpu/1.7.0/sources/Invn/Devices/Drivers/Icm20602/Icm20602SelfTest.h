...
#ifndef _INV_ICM20602_SELFTEST_H_
#define _INV_ICM20602_SELFTEST_H_
...
*                      Accel LP mode X,Y,Z
*/
void INV_EXPORT inv_icm20602_get_st_bias(struct inv_icm20602 * s, int * st_bias);
...
#endif /* _INV_ICM20602_SELFTEST_H_ */
